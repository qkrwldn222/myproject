		...
		<div class="row">
			<table class="table"> 
				...
				<tr>
					...
					<td class="text-left" colspan="3"><a href="download.jsp?fn=${vo.filename }">${vo.filename }</a>(${vo.filesize }Bytes)</td>
				</tr>
				</c:if>
				<tr>
				...
				<tr>
					<td colspan="4" class="text-right">
						<a href="update.jsp?no=${vo.no }&page=${curpage}" class="btn btn-sm btn-primary">수정</a>
